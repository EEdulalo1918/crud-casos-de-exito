...
<head>
    <meta charset="UTF-8">
    <title>Agregar Caso de Éxito</title>
...
<body>
    ...
    <main class="MainContentForm">
        ...
        <div class="divTitle2"><h2>Agregar Caso de Éxito</h2></div>
        
        <form class="frmAgregar" id="formAgregarCasodeExito" enctype="multipart/form-data">
            <label>Nombre:</label>
            <input class="InputsAgregar" type="text" name="txtNombre" required><br>

            <label>Carrera:</label>
            <input class="InputsAgregar" type="text" name="txtCarrera" required><br>
            ...
            <button class="btnCancelar"><a href="vtaCasosExito.php">Cancelar</a></button>
    ...
    <script src="../Js/ajxAgregrarCaso.js">//agregar usuario</script>
