...
<head>
    <meta charset="UTF-8">
    <title>Editar Caso de Éxito</title>
...
<body>
    ...
    <main class="MainContentForm">
        <div class="divTitle2">
            <h2>Editar Caso de Éxito</h2> 
        </div>

        <!-- Contenedor para la imagen -->
        <div class="divImagenContainer">
            <img id="imagenCasodeExito" src="" alt="Imagen del Caso de Éxito">
        </div>

<!--Formulario para mostrar y editar el Caso de Éxito-->
        <form class="frmEditar" id="formEditarCaso" enctype="multipart/form-data">
            <input class="InputsEditar" type="hidden" name="idCaso" id="casoexitoId">

            <label>Nombre:</label>
            <input class="InputsEditar" type="text" name="txtNombre" id="nombre" required><br>

            <label>Carrera:</label>
            <input class="InputsEditar" type="text" name="txtCarrera" id="carrera" required><br>
            ...
            <a class="btnCancelar" href="vtaCasosExito.php">Cancelar</a>
        </form>
...
<!--llamada a los scrips con la información-->
    <script src="../Js/ajxEditarCaso.js"></script>
