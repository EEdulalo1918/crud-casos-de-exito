...
function cargarCasos() {
    fetch('../controlador/cntBolsaUniController.php?action=list')
        .then(r => r.json())
        .then(data => {
            const tbody = document.getElementById('BolsaUniTableBody');
            tbody.innerHTML = '';
            ...
            data.data.forEach(u => {
                ...
                tdId.textContent = u.idPlataforma;//asigna el id al content
                tr.appendChild(tdId);//agregar el idPlataforma al cuerpo de la tabla(tbody)
                ...
                if (u.imgPlataforma) {
                    ...
                    img.src = `../controlador/cntBolsaUniController.php?action=image&name=${u.imgPlataforma}`;
                    img.alt = 'Imagen';
                ...
                aDetalles.href = `vtaDetallesBolsaUni.php?idPlataforma=${u.idPlataforma}`;//le agregamos un enlace
                ...
                aEditar.href = `vtaEditarBolsaUni.php?idPlataforma=${u.idPlataforma}`;//enlace
                ...
                btnEliminar.dataset.id = u.idPlataforma;
            ...
            tbody.querySelectorAll('.btnDelete').forEach(btn => {
                btn.addEventListener('click', e => {
                    ...
                    fd.append('idPlataforma', id);

                    fetch('../controlador/cntBolsaUniController.php', { 
                        method:'POST', 
                        body: fd 
                    })
                    .then(r => r.json())
