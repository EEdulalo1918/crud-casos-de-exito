...
<body>
    ...
    <main class="MainContentForm">
        <div class="divTitle2"><h2>Categoria</h2></div>
        <div class="detalles-Beneficios">                  
            ...
            <form class="frmEditar">
                <input type="hidden" name="idCategoriaBeneficio" id="categoriabeneficioId">
                
                <label>Nombre de la Categoria:</label>
                <input class="InputsEditar" type="text" name="txtNombreCategoria" id="nombrecategoria" readonly><br>

                <a class="btnVolver" href="vtaCategoriaBeneficios.php">Volver</a>
            </form>
        </div>
    </main>


    <script src="../Js/ajxDetallesCategoriaBeneficio.js"></script>
