document.getElementById('formAgregarBeneficio').addEventListener('submit', e => {
    e.preventDefault();
    ...
    fetch('../controlador/cntCategoriaBeneficiosController.php', { method:'POST', body: fd })
      ...
      .then(data=>{
        ...
        if(data.success){
            mensajeDiv.innerHTML = '<p style="color: green;">Categoría agregada correctamente</p>';
            setTimeout(()=>{ window.location.href='vtaCategoriaBeneficios.php'; }, 1200);
        } else {
